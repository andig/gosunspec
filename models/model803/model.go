...
type Block803 struct {
	...
	ModTmpAvg    int16               `sunspec:"offset=8,sf=ModTmp_SF"`
		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: ModTmpMax, Offset: 2, Type: typelabel.Int16, ScaleFactor: "ModTmp_SF", Units: "C", Mandatory: true, Label: "Max Module Temperature", Description: "Maximum temperature for all modules in the bank."},
					...
					{Id: ModTmpAvg, Offset: 8, Type: typelabel.Int16, ScaleFactor: "ModTmp_SF", Units: "C", Label: "Average Module Temperature", Description: "Average temperature for all modules in the bank."},
			...
			{Name: "string",
				...
				Points: []types.Point{
					...
					{Id: StrEvt1, Offset: 20, Type: typelabel.Bitfield32, Mandatory: true, Label: "String Event 1", Description: "Alarms, warnings and status values."},
					{Id: StrEvt2, Offset: 22, Type: typelabel.Bitfield32, Label: "String Event 2", Description: "Alarms, warnings and status values."},
