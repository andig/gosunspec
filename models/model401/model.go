		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: Evt, Offset: 5, Type: typelabel.Bitfield32, Mandatory: true, Label: "Event", Description: "Events"},
					{Id: EvtVnd, Offset: 7, Type: typelabel.Bitfield32, Label: "Vendor Event", Description: "Vendor defined events"},
