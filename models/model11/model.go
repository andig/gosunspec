		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: CfgSt, Offset: 1, Type: typelabel.Bitfield16, Mandatory: true, Label: "Interface Status Flags", Description: "Interface flags."},
					{Id: St, Offset: 2, Type: typelabel.Enum16, Mandatory: true, Label: "Link State", Description: "State information for this interface"},
