...
const (
	ModelID          = 136
	ModelLabel       = "HFRT"
	ModelDescription = "High Frequency Ride-through"
)
...
func (block *Block136) GetId() sunspec.ModelId {
	return ModelID
}
		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: ModEna, Offset: 1, Type: typelabel.Bitfield16, Access: "rw", Mandatory: true, Label: "ModEna", Description: "HFRT control mode. Enable active curve."},
