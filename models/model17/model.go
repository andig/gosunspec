		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: Pty, Offset: 7, Type: typelabel.Enum16, Access: "rw", Mandatory: true, Label: "Parity", Description: "Parity setting"},
					{Id: Dup, Offset: 8, Type: typelabel.Enum16, Access: "rw", Label: "Duplex", Description: "Duplex mode"},
					{Id: Flw, Offset: 9, Type: typelabel.Enum16, Access: "rw", Label: "Flow Control", Description: "Flow Control Method"},
					{Id: Typ, Offset: 10, Type: typelabel.Enum16, Label: "Interface Type", Description: "Interface type"},
					{Id: Pcol, Offset: 11, Type: typelabel.Enum16, Label: "Protocol", Description: "Serial protocol selection"},
				},
			},
		}})
}
