		...
		Blocks: []smdx.BlockElement{
			{
				...
				Points: []smdx.PointElement{
					{Id: Ena, Offset: 0, Type: typelabel.Enum16, Access: "rw", Length: 1, Mandatory: true, Label: "DER Trip HFModule Enable", Description: "DER high frequency trip control enable."},
