		...
		Blocks: []smdx.BlockElement{
			{
				...
				Points: []smdx.PointElement{
					...
					{Id: WMaxLimPct_SF, Offset: 21, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Mandatory: true, Label: "WMaxLimPct_SF", Description: "Scale factor for power output percent."},
					{Id: OutPFSet_SF, Offset: 22, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Mandatory: true, Label: "OutPFSet_SF", Description: "Scale factor for power factor."},
					{Id: VArPct_SF, Offset: 23, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Label: "VArPct_SF", Description: "Scale factor for reactive power percent."},
				},
			},
		}})
}
