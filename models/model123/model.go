		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: Conn, Offset: 2, Type: typelabel.Enum16, Access: "rw", Mandatory: true, Label: "Conn", Description: "Connection control."},
					...
					{Id: WMaxLim_Ena, Offset: 7, Type: typelabel.Enum16, Access: "rw", Mandatory: true, Label: "WMaxLim_Ena", Description: "Throttle enable/disable control."},
					...
					{Id: OutPFSet_Ena, Offset: 12, Type: typelabel.Enum16, Access: "rw", Mandatory: true, Label: "OutPFSet_Ena", Description: "Fixed power factor enable/disable control."},
					...
					{Id: VArPct_Mod, Offset: 19, Type: typelabel.Enum16, Access: "rw", Label: "VArPct_Mod", Description: "VAR percent limit mode."},
					{Id: VArPct_Ena, Offset: 20, Type: typelabel.Enum16, Access: "rw", Mandatory: true, Label: "VArPct_Ena", Description: "Percent limit VAr enable/disable control."},
