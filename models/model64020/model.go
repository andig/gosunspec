...
type Block64020 struct {
	...
	ProbeTmp          int16               `sunspec:"offset=5"`
	MainTmp           int16               `sunspec:"offset=6"`
		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: ProbeTmp, Offset: 5, Type: typelabel.Int16, Units: "C", Mandatory: true, Label: "Probe Temperature", Description: ""},
					{Id: MainTmp, Offset: 6, Type: typelabel.Int16, Units: "C", Mandatory: true, Label: "Main Temperature", Description: ""},
