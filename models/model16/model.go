...
type Block16 struct {
	...
	Cfg    sunspec.Enum16     `sunspec:"offset=4,len=1,access=r"`
	Ctl    sunspec.Enum16     `sunspec:"offset=5,len=1,access=rw"`
	...
	MAC    sunspec.Eui48      `sunspec:"offset=46,len=4,access=r"`
	LnkCtl sunspec.Bitfield16 `sunspec:"offset=50,len=1,access=rw"`
	Pad    sunspec.Pad        `sunspec:"offset=51,len=1,access=r"`
}
		...
		Blocks: []smdx.BlockElement{
			{
				...
				Points: []smdx.PointElement{
					...
					{Id: Cfg, Offset: 4, Type: typelabel.Enum16, Access: "r", Length: 1, Mandatory: true, Label: "Config", Description: "Enumerated value.  Force IPv4 configuration method"},
					{Id: Ctl, Offset: 5, Type: typelabel.Enum16, Access: "rw", Length: 1, Mandatory: true, Label: "Control", Description: "Bitmask value Configure use of services"},
					...
					{Id: MAC, Offset: 46, Type: typelabel.Eui48, Access: "r", Length: 4, Label: "MAC", Description: "IEEE MAC address of this interface"},
					...
					{Id: Pad, Offset: 51, Type: typelabel.Pad, Access: "r", Length: 1},
				},
			},
		}})
}
