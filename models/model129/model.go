...
const (
	ModelID          = 129
	ModelLabel       = "LVRTD"
	ModelDescription = "LVRT Must Disconnect"
)
...
func (block *Block129) GetId() sunspec.ModelId {
	return ModelID
}
		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: ModEna, Offset: 1, Type: typelabel.Bitfield16, Access: "rw", Mandatory: true, Label: "ModEna", Description: "LVRT control mode. Enable active curve."},
