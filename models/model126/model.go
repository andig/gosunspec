...
func (block *Block126) GetId() sunspec.ModelId {
	return ModelID
}
		...
		Blocks: []smdx.BlockElement{
			{
				...
				Points: []smdx.PointElement{
					...
					{Id: DeptRef_SF, Offset: 8, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Mandatory: true, Label: "DeptRef_SF", Description: "scale factor for dependent variable."},
					{Id: RmpIncDec_SF, Offset: 9, Type: typelabel.ScaleFactor, Access: "r", Length: 1},
				},
			},
			{Name: "curve",
				Length: 54,
