...
type Block3 struct {
	...
	Alg   sunspec.Enum16 `sunspec:"offset=56,len=1,access=r"`
	N     uint16         `sunspec:"offset=57,len=1,access=r"`
		...
		Blocks: []smdx.BlockElement{
			{
				...
				Points: []smdx.PointElement{
					...
					{Id: Alg, Offset: 56, Type: typelabel.Enum16, Access: "r", Length: 1, Mandatory: true, Label: "Algorithm", Description: "Algorithm used to compute the digital signature"},
					{Id: N, Offset: 57, Type: typelabel.Uint16, Access: "r", Length: 1, Mandatory: true, Label: "N", Description: "Number of registers comprising the digital signature."},
				},
			},
			{Name: "repeating",
				Length: 1,
