		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: Evt, Offset: 7, Type: typelabel.Bitfield32, Mandatory: true, Label: "Event", Description: "Events"},
					{Id: EvtVnd, Offset: 9, Type: typelabel.Bitfield32, Label: "Vendor Event", Description: "Vendor defined events"},
			...
			{Name: "string",
				...
				Points: []types.Point{
					...
					{Id: EvtVnd, Offset: 3, Type: typelabel.Bitfield32, Label: "Vendor Event", Description: "Vendor defined events"},
