		...
		Blocks: []smdx.BlockElement{
			{
				...
				Points: []smdx.PointElement{
					...
					{Id: NPt, Offset: 6, Type: typelabel.Uint16, Access: "r", Length: 1, Mandatory: true, Label: "NPt", Description: "Number of curve points supported (maximum of 10)."},
					{Id: Hz_SF, Offset: 7, Type: typelabel.ScaleFactor, Units: "SF", Access: "r", Length: 1, Mandatory: true, Label: "Hz_SF", Description: "Scale factor for frequency."},
					{Id: W_SF, Offset: 8, Type: typelabel.ScaleFactor, Units: "SF", Access: "r", Length: 1, Mandatory: true, Label: "W_SF", Description: "Scale factor for percent WRef."},
					{Id: RmpIncDec_SF, Offset: 9, Type: typelabel.ScaleFactor, Units: "SF", Access: "r", Length: 1, Label: "RmpIncDec_SF", Description: "Scale factor for increment and decrement ramps."},
				},
			},
			{Name: "curve",
				Length: 58,
				...
				Points: []smdx.PointElement{
					...
					{Id: ReadOnly, Offset: 57, Type: typelabel.Enum16, Access: "r", Length: 1, Mandatory: true, Label: "ReadOnly", Description: "Enumerated value indicates if curve is read-only or can be modified."},
				},
			},
		}})
}
