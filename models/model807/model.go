		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: Evt1, Offset: 20, Type: typelabel.Bitfield32, Mandatory: true, Label: "String Event 1", Description: "Alarms, warnings and status values."},
					{Id: Evt2, Offset: 22, Type: typelabel.Bitfield32, Mandatory: true, Label: "String Event 2", Description: "Alarms, warnings and status values."},
			...
			{Name: "module",
				...
				Points: []types.Point{
					...
					{Id: ModEvt1, Offset: 16, Type: typelabel.Bitfield32, Mandatory: true, Label: "Module Event 1", Description: "Alarms, warnings and status values."},
					{Id: ModEvt2, Offset: 18, Type: typelabel.Bitfield32, Mandatory: true, Label: "Module Event 2", Description: "Alarms, warnings and status values."},
