...
type Block804Repeat struct {
	...
	ModCellVMinCell   uint16      `sunspec:"offset=6"`
		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: Evt1, Offset: 26, Type: typelabel.Bitfield32, Mandatory: true, Label: "String Event 1", Description: "Alarms, warnings and status values."},
					{Id: Evt2, Offset: 28, Type: typelabel.Bitfield32, Label: "String Event 2", Description: "Alarms, warnings and status values."},
			...
			{Name: "lithium_ion_string_module",
				...
				Points: []types.Point{
					...
					{Id: ModCellVMinCell, Offset: 6, Type: typelabel.Uint16, Label: "Min Cell Voltage Cell", Description: "Cell with minimum voltage."},
