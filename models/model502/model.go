		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: Stat, Offset: 4, Type: typelabel.Enum16, Mandatory: true, Label: "Status", Description: "Module Status Code"},
					{Id: StatVend, Offset: 5, Type: typelabel.Enum16, Label: "Vendor Status", Description: "Module Vendor Status Code"},
					{Id: Evt, Offset: 6, Type: typelabel.Bitfield32, Mandatory: true, Label: "Events", Description: "Module Event Flags"},
