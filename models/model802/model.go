		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: SoCRsvMin, Offset: 8, Type: typelabel.Uint16, ScaleFactor: "SoC_SF", Units: "%WHRtg", Access: "rw", Label: "Min Reserve Percent", Description: "Setpoint for minimum reserve for storage as a percentage of the nominal maximum storage."},
					...
					{Id: Evt1, Offset: 24, Type: typelabel.Bitfield32, Mandatory: true, Label: "Battery Event 1 Bitfield", Description: "Alarms and warnings."},
					{Id: Evt2, Offset: 26, Type: typelabel.Bitfield32, Mandatory: true, Label: "Battery Event 2 Bitfield", Description: "Alarms and warnings."},
