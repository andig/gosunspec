		...
		Blocks: []smdx.BlockElement{
			{
				...
				Points: []smdx.PointElement{
					...
					{Id: ChaState, Offset: 6, Type: typelabel.Uint16, ScaleFactor: "ChaState_SF", Units: "% AhrRtg", Access: "r", Length: 1, Label: "ChaState", Description: "Currently available energy as a percent of the capacity rating."},
					{Id: StorAval, Offset: 7, Type: typelabel.Uint16, ScaleFactor: "StorAval_SF", Units: "AH", Access: "r", Length: 1, Label: "StorAval", Description: "State of charge (ChaState) minus storage reserve (MinRsvPct) times capacity rating (AhrRtg)."},
					{Id: InBatV, Offset: 8, Type: typelabel.Uint16, ScaleFactor: "InBatV_SF", Units: "V", Access: "r", Length: 1, Label: "InBatV", Description: "Internal battery voltage."},
					{Id: ChaSt, Offset: 9, Type: typelabel.Enum16, Access: "r", Length: 1, Label: "ChaSt", Description: "Charge status of storage device. Enumerated value."},
					...
					{Id: WChaMax_SF, Offset: 16, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Mandatory: true, Label: "WChaMax_SF", Description: "Scale factor for maximum charge."},
					{Id: WChaDisChaGra_SF, Offset: 17, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Mandatory: true, Label: "WChaDisChaGra_SF", Description: "Scale factor for maximum charge and discharge rate."},
					{Id: VAChaMax_SF, Offset: 18, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Label: "VAChaMax_SF", Description: "Scale factor for maximum charging VA."},
					{Id: MinRsvPct_SF, Offset: 19, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Label: "MinRsvPct_SF", Description: "Scale factor for minimum reserve percentage."},
					{Id: ChaState_SF, Offset: 20, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Label: "ChaState_SF", Description: "Scale factor for available energy percent."},
					{Id: StorAval_SF, Offset: 21, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Label: "StorAval_SF", Description: "Scale factor for state of charge."},
					{Id: InBatV_SF, Offset: 22, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Label: "InBatV_SF", Description: "Scale factor for battery voltage."},
					{Id: InOutWRte_SF, Offset: 23, Type: typelabel.ScaleFactor, Access: "r", Length: 1, Label: "InOutWRte_SF", Description: "Scale factor for percent charge/discharge rate."},
				},
			},
		}})
}
