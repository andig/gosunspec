		...
		Blocks: []smdx.BlockElement{
			{
				...
				Points: []smdx.PointElement{
					...
					{Id: NSchd, Offset: 3, Type: typelabel.Uint16, Access: "r", Length: 1, Mandatory: true, Label: "NSchd", Description: "Number of schedules supported (recommend min. 4, max 32)"},
					{Id: NPts, Offset: 4, Type: typelabel.Uint16, Access: "r", Length: 1, Mandatory: true, Label: "NPts", Description: "Number of schedule entries supported (maximum of 10)."},
			...
			{Name: "repeating",
				...
				Points: []smdx.PointElement{
					...
					{Id: ActIndx, Offset: 59, Type: typelabel.Uint16, Access: "r", Length: 1, Mandatory: true, Label: "ActIndx", Description: "Index of active entry in the active schedule."},
				},
			},
		}})
}
