		...
		Blocks: []types.Block{
			{
				...
				Points: []types.Point{
					...
					{Id: St, Offset: 46, Type: typelabel.Enum16, Mandatory: true, Label: "Operating State", Description: "Operating state"},
					{Id: StVnd, Offset: 47, Type: typelabel.Enum16, Label: "Vendor Operating State", Description: "Vendor specific operating state code"},
					{Id: Evt1, Offset: 48, Type: typelabel.Bitfield32, Mandatory: true, Label: "Event1", Description: "Event fields"},
